...
def main():
    print("="*60)
    print("🧬 INSPECTING REAL BIOLOGICAL DATA: Heart Cell Atlas")
    print("="*60)
    ...
    print("\n🧬  RAW GENE EXPRESSION (First 5 Cells, Key Regulators):")
    ...
    if len(available_genes) > 0:
        ...
        print("⚠️  Target heart genes not found (Feature selection might have filtered them).")
    ...
    print("\n" + "="*60)
    print("✅ VERIFIED: This is Real Biological Data.")
    print("="*60)
