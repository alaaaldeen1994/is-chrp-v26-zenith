...
def test_lnp_optimized_formulation():
    ...
    # High ionizable lipid + low peg molar fractions, high N/P ratio
    molar_ratios = {"ionizable": 50.0, "cholesterol": 38.5, "helper": 10.0, "peg": 1.5}
    np_ratio = 6.0
    ...
    assert result["heart_selectivity_score"] > 0.60          # Good tropism selectivity
    assert result["formulation_status"] == "OPTIMIZED"
...
def test_lnp_suboptimal_formulation():
    ...
    assert result["formulation_status"] == "SUBOPTIMAL"
