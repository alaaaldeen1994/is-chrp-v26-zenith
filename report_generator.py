...
class ClinicalReportPDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 10, f'Generated by IS-CHRP v26.1 | Page {self.page_no()}', 0, 0, 'C')
...
def generate_clinical_report(session_data: Dict) -> str:
   ...
   # Metadata section
    ...
    pdf.multi_cell(0, 4, 'This report was automatically generated by the IS-CHRP v26.1 Clinical AI Bridge platform. The data represents computational simulation results from a high-fidelity cellular reprogramming model.')
    
    # Save PDF
    pdf.output(pdf_path)
    
    print(f"✅ Clinical report generated: {pdf_path}")
    return pdf_path
