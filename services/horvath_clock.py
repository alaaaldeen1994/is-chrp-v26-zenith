...
class DualAgeReport:
    """Decommissioned report class. Multi-modal comparison endpoints have been removed."""

    @staticmethod
    async def assess(horvath_clock, methylation_betas, gene_expression, chronological_age=50.0):
        raise RuntimeError("DualAgeReport is decommissioned: uncalibrated multi-modal comparison endpoint has been removed.")
